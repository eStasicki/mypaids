  ...
  >
    ...
    >
      ...
      {#if activeTab === "export"}
        <div class="space-y-4">
          <p class="text-gray-400 text-sm mb-4">
            Wyeksportuj swoje dane w formacie JSON, CSV lub PDF. Plik zostanie
            pobrany na Twoje urządzenie.
          </p>
          ...
          {#if $months.length > 0}
            <div class="mb-4">
              <div class="flex items-center justify-between mb-3">
                ...
                <div class="flex gap-2">
                  ...
                  <button
                    ...
                    aria-label={showMonthSelection
                      ? "Ukryj listę miesięcy"
                      : "Pokaż listę miesięcy"}
                  ...
                  >
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3 w-3 transition-transform {showMonthSelection
                        ? 'rotate-180'
                        : ''}"
                      fill="none"
                      viewBox="0 0 24 24"
              ...
              {#if showMonthSelection}
                <div
                  class="max-h-48 overflow-y-auto bg-gray-700/30 rounded-lg border border-gray-600/50 p-3 space-y-2"
                >
                  {#each sortMonthsByDate($months) as month}
                    <label
                      class="flex items-center gap-3 p-2 rounded-lg border transition-all duration-200 cursor-pointer hover:bg-gray-700/30 {selectedMonthsForExport.has(
                        month.id
                      )
                    ...
                    >
                      <input
                        ...
                        aria-label="Zaznacz miesiąc {getMonthName(
                          month.date
                      ...
                      <div class="flex-1">
                        ...
                        <div class="text-xs text-gray-400">
                          {month.date.toLocaleDateString("pl-PL")} • {month
                            .bills.length} rachunków
                        </div>
                      </div>
                    </label>
                  {/each}
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div
                class="w-12 h-12 rounded-lg bg-blue-500/20 flex items-center justify-center border border-blue-500/30 group-hover:bg-blue-500/30 transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <div
                class="w-12 h-12 rounded-lg bg-green-500/20 flex items-center justify-center border border-green-500/30 group-hover:bg-green-500/30 transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <div
                class="w-12 h-12 rounded-lg bg-red-500/20 flex items-center justify-center border border-red-500/30 group-hover:bg-red-500/30 transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      {:else}
        <div class="space-y-4">
          <p class="text-gray-400 text-sm mb-4">
            Zaimportuj dane z pliku JSON lub CSV. Istniejące dane zostaną
            zastąpione.
          </p>
          <div class="space-y-4">
            <label
