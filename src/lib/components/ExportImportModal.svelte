<script lang="ts">
	...
	async function handleImport() {
		...
		try {
			...
			importError = error instanceof Error ? error.message : $_("exportImport.errors.importError");
		}
	}
			...
			{#if activeTab === "export"}
				<div class="space-y-4">
					<p class="text-gray-400 text-sm mb-4">
						Wyeksportuj swoje dane w formacie JSON, CSV lub PDF. Plik zostanie pobrany na Twoje
						urządzenie.
					</p>
							...
							<div class="flex items-center justify-between mb-3">
								...
								<div class="flex gap-2">
									...
									>
										...
										<svg
											xmlns="http://www.w3.org/2000/svg"
											class="h-3 w-3 transition-transform {showMonthSelection ? 'rotate-180' : ''}"
											fill="none"
											viewBox="0 0 24 24"
											stroke="currentColor"
											aria-hidden="true"
