...
{#if isOpen}
	...
	>
		<div
			bind:this={modalRef}
			class="bg-linear-to-br from-gray-800 via-gray-800 to-gray-900 rounded-2xl p-8 max-w-2xl w-full my-auto shadow-2xl border border-gray-700/50 animate-in zoom-in-95 duration-300 focus:outline-none cursor-default max-h-[90vh] overflow-y-auto"
