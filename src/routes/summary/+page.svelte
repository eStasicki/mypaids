    ...
    {#if loadedMonths.length === 0}
      <div class="text-center py-16">
        ...
        <p class="text-sm text-gray-500">
          Dodaj miesiące, aby zobaczyć podsumowanie
        </p>
      </div>
                  ...
                  <div class="space-y-1 text-sm">
                    <div class="flex justify-between">
                      ...
                      <span class="text-white font-medium"
                        >{stat.totalAmount.toFixed(2)} zł</span
                      >
                    </div>
                    <div class="flex justify-between">
                      <span class="text-gray-400">Średnia:</span>
                      <span class="text-white font-medium"
                        >{stat.averageAmount.toFixed(2)} zł</span
                      >
                    </div>
                    <div class="flex justify-between">
              ...
              >
                ...
                <div class="space-y-2 text-sm">
                  <div class="flex justify-between">
                    <span class="text-gray-400">Łączna suma:</span>
                    <span class="text-white font-medium"
                      >{comparison.total.toFixed(2)} zł</span
                    >
                  </div>
                  <div class="flex justify-between">
                    <span class="text-gray-400">Średnia miesięczna:</span>
                    <span class="text-white font-medium"
                      >{comparison.average.toFixed(2)} zł</span
                    >
                  </div>
                  <div class="flex justify-between">
                    <span class="text-gray-400">Liczba miesięcy:</span>
                    <span class="text-white font-medium"
                      >{comparison.monthCount}</span
                    >
                  </div>
                </div>
              </div>
        ...
        >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {#each billTypeAverages.slice(0, 15) as avg}
              <div
                class="p-3 bg-gray-700/30 rounded-lg border border-gray-600/50"
              >
                <div class="font-medium text-white mb-1">{avg.name}</div>
                <div class="flex justify-between text-sm">
                  <span class="text-gray-400">Średnia:</span>
                  <span class="text-white font-semibold"
                    >{avg.average.toFixed(2)} zł</span
                  >
                </div>
